...
import 'package:first_trip_around_the_sun/pages/celebrationPage.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:first_trip_around_the_sun/actors/food.dart';
import 'package:first_trip_around_the_sun/actors/ghost.dart';
import 'package:first_trip_around_the_sun/actors/ghostBlocker.dart';
import 'package:first_trip_around_the_sun/buildingBlocks/pixel.dart';
import 'package:first_trip_around_the_sun/actors/player.dart';
import 'package:first_trip_around_the_sun/pages/homePage.dart';
import 'package:first_trip_around_the_sun/pages/level2Page.dart';
import 'package:first_trip_around_the_sun/utils/constants.dart';
import 'package:first_trip_around_the_sun/utils/helpers.dart';
import 'package:first_trip_around_the_sun/utils/notifiers.dart';
...
class LevelPage extends StatefulWidget {
  ...
  List<int> blockGhost;
  List<String> ghostBlockerImages;
...
class _LevelPageState extends State<LevelPage>
  ...
  late List<String> ghostBlockerImages = List.from(widget.ghostBlockerImages);
          ...
          showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  title: Center(
                      child: Text(
                    levelPage1AlertRunAway,
                    style: TextStyle(fontSize: titleSize, height: textHeight),
                  )),
                  content: Wrap(
                      crossAxisAlignment: WrapCrossAlignment.center,
                      children: [
                        Text(levelPage1AlertRunAwayContext,
                            style: TextStyle(
                                height: textHeight, fontSize: contextSize)),
                        Text("$levelPageAlertOverContext $score",
                            style: TextStyle(
                ...
                child: GestureDetector(
                  ...
                  child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        } else if (widget.blockGhost.contains(index) && blockGhost.contains(index)) {
                          var ghostBlockerImageIndex =
                              widget.blockGhost.indexOf(index);
                          return AnimatedBuilder(
                            animation: animationController,
                            child: GhostBlocker(ghostBlockerImages
                                .elementAt(ghostBlockerImageIndex)),
  ...
  introLevelDialog() {
    return showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text("Ready to gather party treasures?",
            style: TextStyle(height: textHeight, fontSize: titleSize)),
        actions: <Widget>[
          TextButton(
            onPressed: () {
